...
for thisPractice_loop in practice_loop:
    ...
    n_practice_trials +=1
    if n_practice_trials >20 and (running_accuracy/n_practice_trials)>.9:
        break
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    if begin_scan.status == STARTED and t >= (0.0 + (10-win.monitorFramePeriod*0.75)): #most of one frame period left
